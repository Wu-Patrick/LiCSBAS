...
LiCSBAS02_unwrapByGAMMA.py -i "your_intf_list_folder"

****************

LiCSBAS02_ml_prep_InSARProcessor.py -i GEOCdir [-o GEOCmldir] [-n nlook] [--freq float] [--n_para int]
...
unwName = 'unwrap_pha.tif'
cohName = 'coh_multi.tif'
